return {
    ...
    config = function ()
        ...
        lspconfig.gopls.setup({
            on_attach = on_attach, -- Define your on_attach function for actions like jumping to definitions
            capabilities = capabilities,
            cmd = { "gopls" }, -- This line specifies the command to launch the gopls server
            filetypes = { "go", "gomod", "gowork", "gotmpl" }, -- This ensures gopls works with Go files
            settings = { -- Optional: Configure gopls settings
                --  e.g., format on save, etc.
            },
        })
        ...
        lspconfig.pylsp.setup({
            on_attach = on_attach,
            capabilities = capabilities,
            cmd = { "pylsp" }, -- This line specifies the command to launch the python-lsp-server
            filetypes = { "python" }, -- This ensures python-lsp-server works with Python files
            settings = {
